...
User can add below execution parameters as per below. 
   . ProcessId
   . Layout
   . Recordset
   . MachineAttributes
...
If user wants to add multiple execution parameters for different process then he can add like below
