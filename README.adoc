...
image::image26.png[Logheader Id,{thumbnail}]
...
=== Version 5.0.0.0 
   ...
   image::Result_Attribute-Recordset_Jenkins[Certify Result Attribute,{thumbnail}]

   3. Add Result Attribute in the process so it will be available in certify result after the execution CompletedDate 
   as per below image

   image::Process_With_Result_Attribute-Recordset_Jenkins.png[Certify Result Attribute,{thumbnail}]
   ...
   image::images/CTM_New_API.png[CTM New API,{thumbnail}]
   ...
   image::CTM_Plugin_With_Result_Attribute.png[Jenkins with Result Attribute,{thumbnail}]
   ...
   image::image25.png[Result Attribute Jenkins Console,{thumbnail}]

   9. After execution is completed, user can validate Result Attribute value in Certify:

   image::image24.png[Certify Result Attribute,{thumbnail}]
